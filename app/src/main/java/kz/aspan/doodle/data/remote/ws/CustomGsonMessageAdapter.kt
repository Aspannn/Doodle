...
import kz.aspan.doodle.util.Constants.TYPE_ANNOUNCEMENT
import kz.aspan.doodle.util.Constants.TYPE_CHAT_MESSAGE
import kz.aspan.doodle.util.Constants.TYPE_CHOSEN_WORD
import kz.aspan.doodle.util.Constants.TYPE_CUR_ROUND_DRAW_INFO
import kz.aspan.doodle.util.Constants.TYPE_DISCONNECT_REQUEST
import kz.aspan.doodle.util.Constants.TYPE_DRAW_ACTION
import kz.aspan.doodle.util.Constants.TYPE_DRAW_DATA
import kz.aspan.doodle.util.Constants.TYPE_GAME_ERROR
...
import kz.aspan.doodle.util.Constants.TYPE_PING
